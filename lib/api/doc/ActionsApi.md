...
> List<ActionSchema> getActionsByUserActionsUserUserIdGet(userId, limit, actionType)
...
try {
    final result = api_instance.getActionsByUserActionsUserUserIdGet(userId, limit, actionType);
    print(result);
} catch (e) {
