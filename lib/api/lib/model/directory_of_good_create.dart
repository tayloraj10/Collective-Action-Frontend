...
class DirectoryOfGoodCreate {
  ...
  @override
  String toString() => 'DirectoryOfGoodCreate[name=$name, focus=$focus, website=$website, categoryId=$categoryId, imageUrl=$imageUrl, location=$location, socialLinks=$socialLinks]';
