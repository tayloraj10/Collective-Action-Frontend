...
class UserStatsSchema {
  ...
  bool operator ==(Object other) =>
      ...
      other is UserStatsSchema &&
          ...
          _deepEquality.equals(
              other.mapCampaignBreakdown, mapCampaignBreakdown) &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.firstActionDate != null) {
      json[r'first_action_date'] =
          this.firstActionDate!.toUtc().toIso8601String();
    } else {
      json[r'first_action_date'] = null;
    }
    if (this.lastActionDate != null) {
      json[r'last_action_date'] =
          this.lastActionDate!.toUtc().toIso8601String();
    } else {
  ...
  static UserStatsSchema? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "UserStatsSchema[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "UserStatsSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return UserStatsSchema(
        ...
        mapSubmissionCount:
            mapValueOfType<int>(json, r'map_submission_count') ?? 0,
        ...
        treePlantingCount:
            mapValueOfType<int>(json, r'tree_planting_count') ?? 0,
        wildflowerPlantingCount:
            mapValueOfType<int>(json, r'wildflower_planting_count') ?? 0,
        totalPlantings: mapValueOfType<int>(json, r'total_plantings') ?? 0,
        initiativeActionCount:
            mapValueOfType<int>(json, r'initiative_action_count') ?? 0,
        initiativesParticipated:
            mapValueOfType<int>(json, r'initiatives_participated') ?? 0,
        mapCampaignBreakdown: MapCampaignStatsSchema.listFromJson(
            json[r'map_campaign_breakdown']),
        actionTypeCounts:
            mapCastOfType<String, int>(json, r'action_type_counts') ?? const {},
        followsCount: mapValueOfType<int>(json, r'follows_count') ?? 0,
        contributionsCount:
            mapValueOfType<int>(json, r'contributions_count') ?? 0,
        orgId: mapValueOfType<String>(json, r'org_id'),
        orgName: mapValueOfType<String>(json, r'org_name'),
        orgFollowersCount:
            mapValueOfType<int>(json, r'org_followers_count') ?? 0,
        orgPartnershipsCount:
            mapValueOfType<int>(json, r'org_partnerships_count') ?? 0,
        orgInitiativeConnections:
            mapValueOfType<int>(json, r'org_initiative_connections') ?? 0,
  ...
  static List<UserStatsSchema> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UserStatsSchema>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UserStatsSchema.listFromJson(
          entry.value,
          growable: growable,
        );
      }
