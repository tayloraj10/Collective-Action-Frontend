...
class DirectoryOfGoodUpdate {
  ...
  @override
  String toString() => 'DirectoryOfGoodUpdate[name=$name, focus=$focus, categoryIds=$categoryIds, imageUrl=$imageUrl, location=$location, socialLinks=$socialLinks, featured=$featured]';
